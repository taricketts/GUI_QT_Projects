...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FindCrap_t, stringdata) + ofs \
...
const QMetaObject FindCrap::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FindCrap.data,
      qt_meta_data_FindCrap,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FindCrap.stringdata))
